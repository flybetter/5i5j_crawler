...
if __name__ == '__main__':
    ...
    sql = "select id as official_id,district,address,blockshowname,buildarea,floor,totalfloor,price,averprice,room from sell where is_real_house=1 and blockshowname='德盈国际广场'"
    engine = create_engine(
