...
def save_function(results):
    ...
    df_2.columns = ['model', 'area', 'direction', 'district']
...
def url_action(num):
    ...
    url = "http://map.ke.com/proxyApi/i.c-pc-webapi.ke.com/map/drawhouselist?cityId=320100&dataSource=ESF&curPage={}&condition=l3bp0ep210&resblockIds=1411045966153,1411000000039,1411000000613,1411000000670,1411000000807,1411000000853,1411000000065,1411000000293,1411000000506,1411000000557,1411000000007,1411000000064,1411000000135,1411000000476,1411000000699,1411000000707,1411000000814,1411000000816,1411000000862,1411042945603,1411047634823,1411000000005,1411000000010,1411000000011,1411000000091,1411000000213,1411000000413,1411000000441,1411000000467,1411000000496,1411000000516,1411000000780,1411000000901,1411041183926,1411041748814,1411042956541,1411043492179,1411062302233".format(
        str(num))
    response = urllib.request.urlopen(url)
    source = json.loads(response.read().decode('utf-8'))
    return source['data']['list']
    ...
    #     "http://map.ke.com/proxyApi/i.c-pc-webapi.ke.com/map/drawhouselist?cityId=320100&dataSource=ESF&curPage=1&condition=l3a2bp0ep210&resblockIds=1411045966153,1411000000039,1411000000670,1411000000557,1411000000007,1411000000064,1411000000506,1411000000699,1411000000707,1411000000862,1411000000005,1411000000010,1411000000011,1411000000091,1411000000135,1411000000413,1411000000441,1411000000476,1411000000496,1411000000780,1411000000807,1411000000814,1411000000816,1411000000853,1411000000901,1411041183926,1411042956541,1411043492179,1411047634823")
